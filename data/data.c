 ...
 * 
 * Hardware: Pro Micro nRF52840 with the Zephyr Bluetooth host
 * Framework: Zephyr, through the FreeRTOS compatibility shim in utils/compat/
 */
...
LOG_MODULE_REGISTER(data, CONFIG_DJI_REMOTE_LOG_LEVEL);
